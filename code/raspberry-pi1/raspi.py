...
class CMqttController:
    ...
    # @details Cette fonction va servir à récuperer l'ip du broker, les différents topics, les messages et de définir le client (Raspberry_Piste_1)
    # @param self Instance de la classe
    ...
    def __init__(self, broker_ip, topic, display):
        ...
        self.client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION1, "Raspberry_Piste_1")
