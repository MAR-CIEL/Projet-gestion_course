...
<head>
    ...
    <style>
        .critical { color: #dc3545; font-weight: bold; animation: blink 1s infinite; }
    ...
    <div class="row">
        <div class="col-md-6">
			<div class="card shadow-sm mb-4">
				<div class="card-header bg-primary text-white">État du Véhicule (Télémétrie complète)</div>
